...
directory=   {'milk':[3,16],'rice':[25,53],'banana':[20,5],'salt':[20,10],
        ...
        'potato':[15,22],'lays':[20,10],'eggs':[50,5],'wheat':[20,30],'corn flakes':[20,30],
        'paneer':[20,50],'sugar':[30,25],'chillies':[40,30],'mangoes':[25,30]}
                    ...
                    while True:
                        ...
                        if(entered)=='x':
                            ...
                            if not checkout:
                                ...
                                print('\t================================')
                                print('Thanks for shopping with us ',c)
                                total={**total,**checkout}
                                checkout.clear()
                                s=0
                                m=input('press 0 for new order ')
                            ...
                            elif quant>directory[entered][0]:
